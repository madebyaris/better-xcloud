 ...
 static DEFINITIONS = {
  ...
  ui_hide_sections: {
   ...
   multipleOptions: {
    ...
    "stream-your-own-game": t("section-stream-your-own-game")
   },
   params: {
    size: 6
   }
...
`;
var eye_default = `<svg xmlns='http://www.w3.org/2000/svg' fill='#fff' stroke='none ' fill-rule='evenodd' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' viewBox='0 0 32 32'>
  <clipPath id='A'>
...
`;
var eye_slash_default = `<svg xmlns='http://www.w3.org/2000/svg' fill='#fff' stroke='none ' fill-rule='evenodd' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' viewBox='0 0 32 32'>
  <clipPath id='A'>
    <path d='M0 0h32v32H0z'/>
  </clipPath>
  <g clip-path='url(#A)'>
...
`;
 ...
 getPref("ui_hide_sections").includes("stream-your-own-game") && "ignoreStreamYourOwnGameSection",
...
function addCss() {
 ...
 if (PREF_HIDE_SECTIONS.includes("stream-your-own-game")) selectorToHide.push("#BodyContent > div.ByogRow-module__container___FkN8X.HomePage-module__bottomSpacing___ORSxh");
