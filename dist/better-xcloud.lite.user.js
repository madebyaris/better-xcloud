...
class WebGL2Player {
 ...
 forceDrawFrame() {
  let gl = this.gl;
  gl.texSubImage2D(gl.TEXTURE_2D, 0, 0, 0, gl.RGB, gl.UNSIGNED_BYTE, this.$video), gl.drawArrays(gl.TRIANGLES, 0, 6);
 }
 setupRendering() {
  let frameCallback;
